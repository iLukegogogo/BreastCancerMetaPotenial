...
save(file = 'client-side/output/Select.pure.sample.colorectal.cancer.R.output/Select.pure.sample.colorectal.cancer.RData',list=c('pure.PRI.colorectal.cancer.sample','pure.MET.colorectal.cancer.sample'))
