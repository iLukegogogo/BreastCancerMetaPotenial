...
save(file = 'client-side/output/Select.pure.sample.NET.si.cancer.R.output/Select.pure.sample.NET.si.cancer.RData',list=c('pure.PRI.NET.si.cancer.sample','pure.MET.NET.si.cancer.sample'))
