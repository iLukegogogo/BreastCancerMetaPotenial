...
save(file = 'client-side/output/Select.pure.sample.NET.pancreatic.cancer.R.output/Select.pure.sample.NET.pancreatic.cancer.RData',list=c('pure.PRI.NET.pancreatic.cancer.sample','pure.MET.NET.pancreatic.cancer.sample'))
