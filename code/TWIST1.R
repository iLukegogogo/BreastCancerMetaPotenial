...
perform.DE.between.TWIST1.high.and.low <- function(){
  TWIST1        <- "ENSG00000145423" 
  TWIST1.expr   <- PRI.log2.fpkm.matrix[TWIST1,] 
...
TWIST1.dn.signature <- names(TWIST1.dn.gene.freq)[TWIST1.dn.gene.freq >= 6]
TWIST1.up.signature <- names(TWIST1.dn.gene.freq)[TWIST1.up.gene.freq >= 6]
