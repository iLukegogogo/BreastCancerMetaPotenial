...
save(file = 'client-side/output/Select.pure.sample.prostate.cancer.R.output/Select.pure.sample.prostate.cancer.RData',list=c('pure.PRI.prostate.cancer.sample','pure.MET.prostate.cancer.sample'))
