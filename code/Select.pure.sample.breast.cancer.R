...
brca.tcga.meta <- read.delim("~/Project/BreastCancerMetaPotenial/client-side/Data/brca_tcga/brca_tcga_pan_can_atlas/brca_tcga_pan_can_atlas_2018_clinical_data.tsv", stringsAsFactors=FALSE)
duc.sample     <- brca.tcga.meta$Sample.ID[brca.tcga.meta$Cancer.Type.Detailed == 'Breast Invasive Ductal Carcinoma'] %>% as.character()
